...
class NN:
    ...
    def create_model(self, neurons_1=16, neurons_2=8):
        ...
        initialiser = initializers.GlorotUniform(seed=seed_value)

        # Add hidden dense layer with prescribed number of neurons_1
        nn_model.add(Dense(neurons_1, kernel_initializer=initialiser, activation='relu', input_dim=30))

        # Add hidden dense layer with prescribed number of neurons_2
        nn_model.add(Dense(neurons_2, kernel_initializer=initialiser, activation='relu'))

        # Add final layer with set parameters
        nn_model.add(Dense(1, kernel_initializer=initialiser, activation='sigmoid'))
